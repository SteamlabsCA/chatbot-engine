function appendMessage(inputPrompt) {
  ...
  let $bot_response =
    "<li class='bot_response'><img src='https://cdn.glitch.com/a1898aab-94e6-4c8f-8dd2-5de4e5ff6a2b%2Fbot.png?v=1622144125211' class='bot_profile'></img><span class='content_container'><p class='bot_p'>...</p><span class='name_date'><p class='bold_p'>Bot </p><p class='p_time'>" +
    date.toLocaleTimeString() +
    "</p></span></span></li>";
  ...
  document.getElementById("response").scrollTop = document.getElementById(
    "response"
  ).scrollHeight;
}
